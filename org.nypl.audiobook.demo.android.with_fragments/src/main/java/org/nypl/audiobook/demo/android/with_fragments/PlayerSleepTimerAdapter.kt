...
import org.nypl.audiobook.demo.android.with_fragments.PlayerSleepTimerConfiguration.*
...
class PlayerSleepTimerAdapter(
  ...
  override fun onBindViewHolder(
    ...
    holder.text.text =
      PlayerSleepTimerAdapter.textOfConfiguration(resources = this.context.resources, item = item)
