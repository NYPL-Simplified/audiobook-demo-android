...
/*
 * An example download provider.
 */

class ExampleDownloadProvider(
  private val executor: ListeningExecutorService)
  : PlayerDownloadProviderType {

  private val log = LoggerFactory.getLogger(ExampleDownloadProvider::class.java)
  ...
  private fun doCleanUp(request: PlayerDownloadRequest) {
    ...
    ExampleFileIO.fileDelete(request.outputFile)
  }
